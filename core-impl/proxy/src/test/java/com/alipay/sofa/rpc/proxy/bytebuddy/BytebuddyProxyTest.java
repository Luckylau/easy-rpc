...
/**
 * @author bystander
 * @version $Id: BytebuddyTest.java, v 0.1 2019年01月30日 11:16 bystander Exp $
 */
public class BytebuddyProxyTest {

    private final static Logger LOGGER = LoggerFactory.getLogger(BytebuddyProxyTest.class);
